...
const routes: Routes = [
  ...
  // country corona
  {path:'corona-country',component: CoronaCountryComponent},
  // news corona
  {path:'corona-news', component: CoronaGraphyComponent},
  // list album
  {path:'list-album', component:ListAlbumComponent},
  // detail photo
  {path:'detail-photo/:id/:idAlbum', component: DetailPhotoComponent},
  // list photo
  {path:'list-photo', component: ListPhotoComponent},
  // detail todo
  {path: 'detail-todo/:id', component:DetailTodoComponent},
  // list todo (page, size)
  {path:'list-todo/:page/:size', component: ListTodoComponent},
  // detail post
  {path:'detail/:id', component: DetailPostComponent},
  // list poster
  {path:'list-poster', component:ListPosterComponent},
  // default page (home-page)
  {path:'', redirectTo:'/home-page', pathMatch:'full'},
  // detail forcast
  {path:'detail-forcast/:id', component:DetailForcastComponent},
  // home-page
  ...
  // path variable
  {path:'parameter/:id', component:PamameterComponent},
  {path:'parameter/:id/:idUser', component:PamameterComponent},
